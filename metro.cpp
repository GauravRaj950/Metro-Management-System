...
public:
	void CreateEmployee()
	{
		...
		system("cls");
		cout<<"***********************************************"<<endl;
		cout<<"\t\tWelcome to Patna Metro"<<endl;
		cout<<"***********************************************"<<endl;
...
void SelectTrain()
{
    ...
    cout<<"\t\t\t Patna Metro\n";
    cout<<"**********************************************************\n";
    fl.open("card.txt", ios::in| ios::out);
    int card_num;
...
void UpdateBalance()
{
    ...
    cout<<"**********************************************************\n";
    int num;
    file.open("card.txt", ios::in|ios::out);
    cout<<"Please, Enter the Card number: ";
    cin>>num;
    while(file.read((char *)& card, sizeof(MetroCard)))
    {
...
void UpdateTrain()
{
        ...
        cin>>train_num;
        file.open("metro.txt", ios::in | ios::out);
        //file.seekg(ios::beg);
        while(file.read((char *)& train, sizeof(MetroTrain)))
        {
...
void MetroMenu()
{
    ...
    {
    case 1:
        file.open("metro.txt", ios::out | ios::app);
        train.GetTrain();
        file.write((char *)& train, sizeof(MetroTrain));
        file.close();
...
void MainMenu()
    ...
    case 3:
        ...
        break;
    case 4:
        cout<<"Thank you for using Patna Metro Service\n";
        system("pause");
        break;
    default:
        cout<<"Please Enter a Valid Input\n";
